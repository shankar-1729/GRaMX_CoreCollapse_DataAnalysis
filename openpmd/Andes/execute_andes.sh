...
scp -oControlMaster=auto -oControlPath=~/.ssh/copy_code-%C -oControlPersist=3600 plot_final.py  sshanka@andes.olcf.ornl.gov:/gpfs/alpine/ast154/scratch/sshanka/carpetx_github/openpmd/plot.py
