...
def get_data(group, gf, x_slice, data_dir, input_iteration):
    ...
    return selected_iteration, time, x0, y0, dx, dy, variable_2d_xy, level   
...
#TODO: This is actually y_slice
x_slice = 0.0 #-11.0 #-211.0
...
for output_number in range(80, 81):
#for output_number in range(0, 1):
    sim_name = "CCSN_12000km"   
    #sim_name = "debug_production24"
    ...
    for input_iteration in iteration_numbers:
        ...
        group = "shocktracker_shock_radius"
        gf = "shocktracker_shock_radius"
        norm = "linear"
        vmin_set = None
        vmax_set = None
        selected_iteration, time, y0, z0, dy, dz, variable_2d_yz = \
        ...
        group = "shocktracker_shock_radius_x"
        gf = "shocktracker_shock_radius_x"
        norm = "linear"
        vmin_set = None
        vmax_set = None
        selected_iteration, time, y0, z0, dy, dz, variable_2d_yz = \
        ...
        group = "shocktracker_shock_radius_y"
        gf = "shocktracker_shock_radius_y"
        norm = "linear"
        vmin_set = None
        vmax_set = None
        selected_iteration, time, y0, z0, dy, dz, variable_2d_yz = \
        ...
        group = "shocktracker_shock_radius_z"
        gf = "shocktracker_shock_radius_z"
        norm = "linear"
        vmin_set = None
        vmax_set = None
        selected_iteration, time, y0, z0, dy, dz, variable_2d_yz = \
        ...
        plot_data(selected_iteration, time, y0, z0, dy, dz, b2, "bcom_sq", None, None, norm)
        plot_data(selected_iteration, time, y0, z0, dy, dz, w, "w_lorentz", None, None, "linear")
        '''
