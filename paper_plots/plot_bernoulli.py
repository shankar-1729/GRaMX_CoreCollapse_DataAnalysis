...
def get_plasma_beta_xz(x_slice, data_dir, input_iteration, level):
    ...
    selected_iteration, time, y0, z0, dy, dz, eps_2d_yz = get_data_xz("hydrobase_eps", "hydrobase_eps", x_slice, data_dir, input_iteration, level)
    ...
    selected_iteration, time, y0, z0, dy, dz, alp_2d_yz = get_data_xz("admbase_lapse", "admbase_alp", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, betax_2d_yz = get_data_xz("admbase_shift", "admbase_betax", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, betay_2d_yz = get_data_xz("admbase_shift", "admbase_betay", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, betaz_2d_yz = get_data_xz("admbase_shift", "admbase_betaz", x_slice, data_dir, input_iteration, level)
    ...
    alp_2d_yz_ccc = np.zeros((gzz_2d_yz.shape[0]-1, gzz_2d_yz.shape[1]-1))
    betax_2d_yz_ccc = np.zeros((gzz_2d_yz.shape[0]-1, gzz_2d_yz.shape[1]-1))
    betay_2d_yz_ccc = np.zeros((gzz_2d_yz.shape[0]-1, gzz_2d_yz.shape[1]-1))
    betaz_2d_yz_ccc = np.zeros((gzz_2d_yz.shape[0]-1, gzz_2d_yz.shape[1]-1))
    
    
    gxx_2d_yz_ccc = gxx_2d_yz[:-1, :-1].copy()  
    gxy_2d_yz_ccc = gxy_2d_yz[:-1, :-1].copy() 
    gxz_2d_yz_ccc = gxz_2d_yz[:-1, :-1].copy() 
    gyy_2d_yz_ccc = gyy_2d_yz[:-1, :-1].copy() 
    gyz_2d_yz_ccc = gyz_2d_yz[:-1, :-1].copy() 
    gzz_2d_yz_ccc = gzz_2d_yz[:-1, :-1].copy() 
    alp_2d_yz_ccc = alp_2d_yz[:-1, :-1].copy() 
    betax_2d_yz_ccc = betax_2d_yz[:-1, :-1].copy() 
    betay_2d_yz_ccc = betay_2d_yz[:-1, :-1].copy() 
    betaz_2d_yz_ccc = betaz_2d_yz[:-1, :-1].copy() 
...
def plot_data_xz(selected_iteration, time, y0, z0, dy, dz, variable_2d_yz, gf, vmin_set, vmax_set, norm, level, x_slice, colormap, xmin, xmax, ymin, ymax, M_to_km):
    ...
    if norm == "linear":     
        ...
        plt.pcolor(M_to_km*y, M_to_km*z, variable_2d_yz_abs, cmap=colormap, norm=colors.LogNorm(vmin=vmin_abs, vmax=vmax_abs))
    else:
    ...
    plt.savefig("{}/ref{}/{}_xz_it{}.png".format(gf, level, gf, selected_iteration))
    plt.close()
...
def get_plasma_beta_yz(x_slice, data_dir, input_iteration, level):
    ...
    selected_iteration, time, y0, z0, dy, dz, eps_2d_yz = get_data_yz("hydrobase_eps", "hydrobase_eps", x_slice, data_dir, input_iteration, level)
    ...
    selected_iteration, time, y0, z0, dy, dz, alp_2d_yz = get_data_yz("admbase_lapse", "admbase_alp", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, betax_2d_yz = get_data_yz("admbase_shift", "admbase_betax", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, betay_2d_yz = get_data_yz("admbase_shift", "admbase_betay", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, betaz_2d_yz = get_data_yz("admbase_shift", "admbase_betaz", x_slice, data_dir, input_iteration, level)
...
def plot_data_yz(selected_iteration, time, y0, z0, dy, dz, variable_2d_yz, gf, vmin_set, vmax_set, norm, level, x_slice, colormap, xmin, xmax, ymin, ymax, M_to_km):
    ...
    plt.savefig("{}/ref{}/{}_yz_it{}.png".format(gf, level, gf, selected_iteration))
    plt.close()
...
def get_plasma_beta_xy(x_slice, data_dir, input_iteration, level):
    #Plot the plasma-beta
    selected_iteration, time, y0, z0, dy, dz, press_2d_yz = get_data_xy("hydrobase_press", "hydrobase_press", x_slice, data_dir, input_iteration, level)

    selected_iteration, time, y0, z0, dy, dz, bvecx_2d_yz = get_data_xy("hydrobase_bvec", "hydrobase_bvecx", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, bvecy_2d_yz = get_data_xy("hydrobase_bvec", "hydrobase_bvecy", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, bvecz_2d_yz = get_data_xy("hydrobase_bvec", "hydrobase_bvecz", x_slice, data_dir, input_iteration, level)

    selected_iteration, time, y0, z0, dy, dz, velx_2d_yz = get_data_xy("hydrobase_vel", "hydrobase_velx", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, vely_2d_yz = get_data_xy("hydrobase_vel", "hydrobase_vely", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, velz_2d_yz = get_data_xy("hydrobase_vel", "hydrobase_velz", x_slice, data_dir, input_iteration, level)

    selected_iteration, time, y0, z0, dy, dz, gxx_2d_yz = get_data_xy("admbase_metric", "admbase_gxx", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, gxy_2d_yz = get_data_xy("admbase_metric", "admbase_gxy", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, gxz_2d_yz = get_data_xy("admbase_metric", "admbase_gxz", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, gyy_2d_yz = get_data_xy("admbase_metric", "admbase_gyy", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, gyz_2d_yz = get_data_xy("admbase_metric", "admbase_gyz", x_slice, data_dir, input_iteration, level)
    selected_iteration, time, y0, z0, dy, dz, gzz_2d_yz = get_data_xy("admbase_metric", "admbase_gzz", x_slice, data_dir, input_iteration, level)
    
    selected_iteration, time, y0, z0, dy, dz, rho_2d_yz = get_data_xy("hydrobase_rho", "hydrobase_rho", x_slice, data_dir, input_iteration, level)
...
def plot_data_xy(selected_iteration, time, y0, z0, dy, dz, variable_2d_yz, gf, vmin_set, vmax_set, norm, level, x_slice, colormap, xmin, xmax, ymin, ymax, M_to_km):
    ...
    plt.savefig("{}/ref{}/{}_xy_it{}.png".format(gf, level, gf, selected_iteration))
    plt.close()
...
def plot_xz(data_dir, input_iteration, groups, gfs, norms, vmins, vmaxs, level, y_slice, colormap, xmin, xmax, ymin, ymax, M_to_km):
    ...
    for i in range(num_groups):
        ...
        plot_data_xz(selected_iteration, time, y0, z0, dy, dz, variable_2d, gf, vmin_set, vmax_set, norm, level, y_slice, colormap, xmin, xmax, ymin, ymax, M_to_km)
        

def plot_yz(data_dir, input_iteration, groups, gfs, norms, vmins, vmaxs, level, x_slice, colormap, xmin, xmax, ymin, ymax, M_to_km):
    num_groups = len(groups)
    for i in range(num_groups):
        group = groups[i]
        gf = gfs[i]
        ...
        plot_data_yz(selected_iteration, time, y0, z0, dy, dz, variable_2d, gf, vmin_set, vmax_set, norm, level, x_slice, colormap, xmin, xmax, ymin, ymax, M_to_km)

def plot_xy(data_dir, input_iteration, groups, gfs, norms, vmins, vmaxs, level, z_slice, colormap, xmin, xmax, ymin, ymax, M_to_km):
    num_groups = len(groups)
    for i in range(num_groups):
        group = groups[i]
        gf = gfs[i]
        ...
        plot_data_xy(selected_iteration, time, y0, z0, dy, dz, variable_2d, gf, vmin_set, vmax_set, norm, level, z_slice, colormap, xmin, xmax, ymin, ymax, M_to_km)
...
for output_number in range(90, 91):   #54 is the last for "Ref6_40"
    ...
    colormap = "Greys" #"plasma" #"seismic_r" # #"turbo"
    M_to_km = 1.477  #1.0
    ...
    for input_iteration in iteration_numbers:
        ...
        ymin = None #-2000
        ymax = None #2000
        plot_xz(data_dir, input_iteration, groups, gfs, norms, vmins, vmaxs, level, y_slice, colormap, xmin, xmax, ymin, ymax, M_to_km)
        ...
        ymin = None
        ymax = None
        plot_yz(data_dir, input_iteration, groups, gfs, norms, vmins, vmaxs, level, x_slice, colormap, xmin, xmax, ymin, ymax, M_to_km)
        ...
        ymin = None
        ymax = None
        #plot_xy(data_dir, input_iteration, groups, gfs, norms, vmins, vmaxs, level, z_slice, colormap, xmin, xmax, ymin, ymax, M_to_km)
