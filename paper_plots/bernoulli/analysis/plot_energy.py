...
ax.plot(t_pb_ms, ejecta_TE_erg/1.0e50, linewidth=4,  color="tab:red", marker="", markersize=12,  label="Explosion energy")
ax.plot(t_pb_ms, ejecta_KE_erg/1.0e50, linewidth=4,  color="tab:blue", linestyle="dashed",  label="Kinetic energy")
ax.plot(t_pb_ms, ejecta_IE_erg/1.0e50, linewidth=4,  color="orchid", linestyle="dashed", label="Internal energy")
ax.plot(t_pb_ms, ejecta_ME_erg/1.0e50, linewidth=4,  color="tab:green", linestyle="dashed", label="Magnetic energy")


# Add the x and y-axis labels
ax.set_xlabel(r't - $\mathregular{t_b}$ [ms]', labelpad=15)
ax.set_ylabel(r'Energy [$\times 10^{50}$ erg]', labelpad=15)

# Add legend to plot
ax.legend(bbox_to_anchor=(0, 1), loc=2, frameon=False, fontsize=20)


plt.savefig('explosion_energy_vs_time_bernoulli_gt0.999.png', dpi=300, transparent=False, bbox_inches='tight')
plt.savefig('explosion_energy_vs_time_bernoulli_gt0.999.pdf', transparent=False, bbox_inches='tight', format="pdf")
#plt.show()
